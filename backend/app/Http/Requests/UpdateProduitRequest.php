...
class UpdateProduitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'reference'             => 'sometimes|string|max:50|unique:tenant.produits,reference,' . $produitId,
            ...
            'reference_oem'         => 'nullable|string|max:100',
            'compatible_ids'        => 'nullable|array',
            'compatible_ids.*'      => 'integer|exists:tenant.produits,id',
            'prix_ht_achat'         => 'nullable|numeric|min:0',
            'prix_ht_vente'         => 'nullable|numeric|min:0',
