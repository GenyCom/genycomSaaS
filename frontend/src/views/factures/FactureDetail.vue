  ...
  <div class="animate-fade-in">
    <div class="flex items-center justify-between mb-3">
      <div class="flex items-center gap-2">
        <router-link to="/factures" class="btn btn-secondary btn-sm">← Retour</router-link>
        <h2 style="font-size:1.1rem; font-weight:600;">{{ isNew ? 'Nouvelle Facture' : 'Détail de la Facture ' + form.numero }}</h2>
      </div>
        ...
        <div>
           ...
           <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
              ...
              <div class="form-group">
                ...
                <input v-model="form.date_facture" type="date" class="form-input" />
              </div>
              <div class="form-group">
...
if (isNew.value) {
  ...
  form.value.numero = 'FAC-202604-0001'
...
function save() {
  alert('Facture enregistrée avec succès (Mode Démo)')
  router.push('/factures')
}

function imprimer() {
  window.open(`/print/facture/${form.value.numero}`, '_blank')
}
</script>
