    ...
    <div class="kpi-strip">
      ...
      <div class="kpi-item br-accent">
        ...
        <div class="kpi-body">
          ...
          <p class="kpi-value highlighted-kpi">{{ formatMoney(totalHT) }} <span>DH</span></p>
        </div>
      </div>
    </div>
              ...
              <div class="search-input-wrapper">
                ...
                <ul v-if="searchResults.length > 0" class="search-dropdown">
                  ...
                  >
                    ...
                    <div class="prod-price">{{ formatMoney(prod.prix_ht_achat || 0) }} DH HT</div>
                  </li>
                </ul>
            ...
            <table class="saas-table">
              <thead>
                <tr>
                  ...
                  <th style="width: 14%; padding: 13px 4px;" class="text-center">Qté Reçue</th>
                  <th style="width: 16%; padding: 13px 4px;" class="text-center">P.U HT (Achat)</th>
              ...
              <tbody>
                <tr v-for="(l, idx) in form.lignes" :key="idx" class="ligne-row">
                  <td>
                    <template v-if="isNew">
                  ...
                  <td class="text-center">
                    ...
                    <span v-else class="status-pill status-br-light font-black" style="display: inline-block;">{{ l.quantite_recue }}</span>
                  </td>
                  <td class="text-center">
                  ...
                  <td class="text-center mono font-bold">{{ formatMoney((l.quantite_recue || 0) * (l.prix_unitaire || 0)) }}</td>
...
function ajouterProduitAuDocument(produit) {
  const pu = produit.prix_ht_achat || 0
...
.search-input:focus { border-color: #D97706; box-shadow: 0 0 0 4px #FEF3C7; }
...
.prod-price { font-family: 'JetBrains Mono', monospace; font-weight: 800; color: #F59E0B; font-size: .85rem; }
