<template>
  <div class="dashboard-view">
    ...
    <div v-if="authStore.entreprise" class="hero-header dashboard-hero">
      <div class="hero-avatar company-logo">
        <img v-if="authStore.entreprise.logo_path" :src="authStore.entreprise.logo_path" alt="Logo" />
        <span v-else>{{ authStore.entreprise.raison_sociale?.charAt(0) }}</span>
      </div>
      <div class="hero-meta">
