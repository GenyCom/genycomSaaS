  ...
  <div class="client-list-view">
    <Transition name="fade">
      <div v-if="loading" class="loading-overlay">
        ...
        <p class="loading-label">Chargement de la liste…</p>
      </div>
    </Transition>
    ...
    <ConfirmModal 
      ...
      message="Êtes-vous sûr de vouloir supprimer ce compte client ? Cette action est irréversible et effacera l'historique associé si aucune pièce n'est liée."
    ...
    <div class="topbar">
      <div class="topbar-left">
        <div class="breadcrumb">
          ...
          <span class="breadcrumb-current">Clients</span>
        </div>
      </div>
      <div class="topbar-actions">
        <router-link to="/clients/create" class="btn-primary-custom">
    ...
    <div class="hero-header">
      ...
      <div class="hero-meta">
        ...
        <h1 class="hero-name">Répertoire Clients</h1>
        <p class="hero-sub">Vous avez <strong>{{ clients.length }}</strong> client(s) actif(s) dans votre portefeuille.</p>
      </div>
    </div>
    ...
    <div class="filters-card">
      <div class="search-wrapper">
        ...
        <input v-model="search" type="text" placeholder="Rechercher par nom, société, email, ICE..." />
      </div>
    </div>
            ...
            <tr v-for="client in filteredClients" :key="client.id" class="table-row">
              ...
              <td>
                <div class="location-info">
                  <span class="ville">{{ (client.ville || '—').toUpperCase() }}</span>
                  <span class="pays">{{ client.pays || 'Maroc' }}</span>
                </div>
              </td>
              <td>
                <div class="contact-stack">
                  <div class="phone">{{ client.telephone || client.mobile || '—' }}</div>
              ...
              <td class="text-right">
                <div class="actions-group">
                  <router-link :to="`/clients/${client.id}`" class="action-btn view" title="Détails">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                  </router-link>
                  <router-link :to="`/clients/${client.id}/edit`" class="action-btn edit" title="Modifier">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                  </router-link>
                  <button @click="deleteClient(client.id)" class="action-btn delete" title="Supprimer">
