...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'produits/fini/new', name: 'ProduitFiniCreate', component: () => import('../views/produits/ProduitFiniForm.vue'), props: { isNew: true } },
      { path: 'produits/fini/:id/edit', name: 'ProduitFiniEdit', component: () => import('../views/produits/ProduitFiniForm.vue'), props: true },
      { path: 'produits/fini/:id', name: 'ProduitFiniDetail', component: () => import('../views/produits/ProduitFiniDetail.vue'), props: true },
